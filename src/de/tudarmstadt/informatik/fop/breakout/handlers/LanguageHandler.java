...
public class LanguageHandler {
	...
	public static String YOUR_TIME_X;
	public static String X_SECONDS;
	public static String YOU_DESTROYED_X;
	public static String X_BLOCKS;
	public static String YOU_SCORED_X;
	...
	public static void readLang() {
		...
		try {
			...
			YOUR_TIME_X = langContent[26];
			X_SECONDS = langContent[27];
			YOU_DESTROYED_X = langContent[28];
			X_BLOCKS = langContent[29];
			YOU_SCORED_X = langContent[30];
